...
function sendmail($nguoi_nhan,$tieu_de,$noi_dung, $bat_html=0)
{
	...
	include 'admin/system/autoload.php';	
	$mailcfg['mailfrom'] = isset($_POST['gov_email']) ? $_POST['gov_email'] : $_POST['bill_email'];
	$mailcfg['fromname'] = 'Cyrus Nguyen';
	$mailcfg['smtpauth'] = 1;
	$mailcfg['smtphost'] = 'smtp.gmail.com';
	$mailcfg['smtpuser'] = 'tringuyen20101998bb@gmail.com'; //ten dang nhap gmail (server mail ben thu 3)
	$mailcfg['smtppass'] = 'hhumtnumujpwjwpq';//AETPTexeg9nC';//'HPAdxgDAnMAu'; //mat khau dang nhap email
