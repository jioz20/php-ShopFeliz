...
<body class="off-canvas-sidebar">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse">
                <ul class="nav navbar-nav navbar-right">
                    <li class=" active ">
                        <a href="?controller=hethong&action=register">
                            <i class="material-icons">person_add</i> Register
                        </a>
                    </li>
                    <li class="">
                        <a href="?controller=hethong&action=login">
    ...
    <div class="wrapper wrapper-full-page">
        <div class="full-page login-page" filter-color="black" data-image="<?php echo TEMPLATE_PATH; ?>assets/img/register.jpeg">
...
<script src="<?php echo TEMPLATE_PATH; ?>assets/js/chartist.min.js"></script>
...
<script src="<?php echo TEMPLATE_PATH; ?>assets/js/jquery-jvectormap.js"></script>
